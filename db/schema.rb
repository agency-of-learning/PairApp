...
ActiveRecord::Schema[7.0].define(version: 20_230_723_232_751) do
  ...
  create_table 'feedbacks', force: :cascade do |t|
    ...
    t.index %w[referenceable_type referenceable_id], name: 'index_feedbacks_on_referenceable'
  end
  ...
  create_table 'standup_meeting_groups_users', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[standup_meeting_group_id user_id], name: 'index_smg_users_on_smg_id_and_user_id'
    t.index %w[user_id standup_meeting_group_id], name: 'index_smg_users_on_user_id_and_smg_id'
  end

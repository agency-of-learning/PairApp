class Admin::UserMenteeApplications::MenteeApplicationStatesController < ApplicationController
  ...
  def create
    respond_to do |format|
      ...
      format.html do
        redirect_to new_admin_user_mentee_application_mentee_application_state_path(@user_mentee_application),
          alert: e.message
      end
